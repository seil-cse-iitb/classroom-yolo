...
def main():
    ...
    print "Unit Testing.."
    cam_201_1 = "rtsp://10.129.23.235:1024/ISAPI/streaming/channels/101?auth=YWRtaW46dGhlY2FtQHNlaWw="
    #cam_201_2 = "rtsp://10.129.23.236:554/ISAPI/streaming/channels/101?auth=YWRtaW46dGhlY2FtQHNlaWw="
    #cam_201_3 = "rtsp://10.129.23.237:554/ISAPI/streaming/channels/101?auth=YWRtaW46dGhlY2FtQHNlaWw="
    ...
    print "Overall Presence: " + str(HD1)
